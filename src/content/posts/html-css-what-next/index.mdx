...
og_description: Have you learned some HTML and CSS but feel like the website |
  ...
  your reach? Here's a few choices for your next steps!
---

## Outgrowing HTML and CSS

After building a few HTML pages, you may start to feel that your website dreams
are slowed down by repeated tasks, or that you wish to give your visitors more
fanciful interactions than you can figure out how to build. These difficulties
might include (or look similar to) these:
...
> NOTE: If you're very ambitious, you might choose to start directly with the
> "Static Site Generator" path, and learn HTML and CSS as you go. While some
> might caution you against it, as a fellow "throwing myself off the deep end"
> learner, I say: _don't let your dreams be dreams!_
