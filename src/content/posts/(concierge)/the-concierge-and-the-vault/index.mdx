...
![](./like-its-hard.gif)
<figcaption>
Sometimes things that are hard are worth doing; other times they aren't, but some fool (me) needs to
prove they're possible; and sometimes, like this one, it's both.
</figcaption>
</figure>
...
![file:](./oauth-screen.png)
<figcaption>
  So many tears shed over such simple screens.
</figcaption>
</figure>
...
<figcaption>
  Slides from <a href="https://atprotocommunity.leaflet.pub/3mbhlzkuhd22vmy">my ATmosphereConf talk</a>, 
  showing the presence of a Labeler Service
