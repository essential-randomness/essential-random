...
building to conflict resolution, from negotiation to project management, **niche
communities will need many different skills to build a better future for
themselves and the web.** This road is much harder without approachable and trusted
resources to learn them from.
...
company can replicate. While the road to manifesting and harnessing this vision
will be difficult, nothing ambitious ever looks easy from its starting point.
