...
## `getStaticPaths` in Astro (and theoretically NextJS)
...
Note that **unlike params (that the SSG needs to know what to generate), props
is completely optional**: if we preferred to, we could simply load the post data
