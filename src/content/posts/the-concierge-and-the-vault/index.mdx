...
...and many more. This category of data often varies across community and
...
think of a community that may want to it to be private and not directly
...
exisiting: it will just end up within individual Arbiters (or Concierges)
instead.**
...
_The Vault_ is a data store where:
...
How do we enable a community to chooose a different concierge should their current
...
2. The new Concierge can act on the same data as the previous one, including the
   _private data in the Community's Vault_ **which removed the need to hold
...
fuck-ass Astro Website_—know it should now go _somewhere else_ to ask it be
fulfilled?**
...
2. A standardized way for Concierges to forward requests to other Services whose
   endpoints it doesn't directly implement, as chosen by the Community rather than
   by the requester

This second a bit may seem more involved than what we have today, but honestly?
Not by much.
...
what ATproto does with labelers account _today_.**
...
<figcaption>
  Slides from my ATmosphereConf talk, showing the presence of a Labeler Services
...
the rest in a few days, but I wanted to show how this might look like in
practice.
...
Here's my examples, in both read and write edition, using the `community.lexicon`
...
at 5AM for a week to write this article—not to mention, _the whole rest of it._

Thanks for reading!

## _Sleight of Hand:_ It was ~~Communities~~ Users All Along!
...
[^15a]:
    ...
    BobaBoard"_) because you don't have a username, and then—after _years pass_—**have people
...
[^16]:
    ...
    **tl;dr:** most Users don't host their PDSes, but that doesn't mean they don't "own" their data.
    ...
    than what ATproto already asks them.
