...
tags:
  - +bobaboard
created_at: 2024-03-29 15:36:16
og_title: Nudging the Bird out of the Nest
---

If you read the news, it's true: we've taken a bold step in turning BobaBoard
into a real "community project." This has a few implications, but the biggest
one is: **I'm stepping down as the official lead of BobaBoard to become a
...
With this said, launching something that ambitious in a narrow window of time
(we had only two months from conception to launch), and the incredible amount of
effort it required from me and those who chose to join to see it through showed
me how much what we had built relied on me. As I spent two months focusing my
every waking moment on this specific project, issues that would pop up in other
parts of the ecosystem were forced to take a backseat, or to be addressed in a
satisfactory-but-less-than-ideal fashion.
...
notice. It was also impossible, with my (and only my) reputation and livelihood
on the line, to take risks that could cause a visible public fallout that I
would be forced to address without the resources to do so effectively while
