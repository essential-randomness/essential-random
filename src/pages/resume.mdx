...
**Currently available at a target rate of $350/hr.** Reach out at
...
I've worked with and mentored a wide variety of people from many backgrounds,
...
leading projects using React, NextJS, React Query and Astro for the past 5 years.** I love
building plugins, and I've done so for Storybook, Vite, MDX (UnifiedJS), Astro,
Jest, Express and more. I also love integrating software together, and I've done
work with PayPal, Stripe, Discord, social sites including Twitter and Tumblr,
GitHub (including Actions) and others.

**I have experience across the full webdev stack**, including Express, PostreSQL,
SQLite, Redis, and others. I love building libraries on NPM and REST APIs. I have
some experience with system administration, including NixOS and NGINX.
...
In my professional career, I've also worked with Python and C++.
