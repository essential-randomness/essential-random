...
title: Hire Me | Essential Randomness
---
...
launching multiple Kickstarters, writing books about version control, and programming
...
(Express, PostgreSQL, SQLite, Redis, Drizzle, and others), frontend (including
...
- Successfully raised $27k across two crowdfunding campaigns targeting niche
  markets
- Balanced technical decisions with business constraints with uncommon technical
...
- Founded and managed multiple small communities, including an almost-500-people
...
- Currently scaling multiple organizations I founded which include both a
  technology-focused business and a technology-related non-profit initiative
