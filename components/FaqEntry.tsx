export const FaqEntry = () => {
  return (
    <>
      ...
      <details>
        <summary>What if I'm not from a poor country, just poor?</summary>Oh no
        someone has lied on the internet and now can actually afford to support
        me, how will i ever financially recover
      </details>
    </>
  );
};
