...
# tags: +write high edit sober, +design docs, "yes, I did write this while high, and what a better way to set the tone",
# "jokes aside, the really, _really_ hard part of all of this is that"
---

# ~~test~~ A quick primer on this blog (engine)
